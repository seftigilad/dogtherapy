...
<html lang="he">
	<head>
		<title>בלוג כלבנות טיפולית | טיפים והשראה - בתאל ואיימי, באר יעקב</title>
 ...
 <noscript
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="gefen.html" class="nav-link"> גפ"ן</a></li>   
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_5.jpg');" data-stellar-background-ratio="0.5">
      ...
      <?php
       ...
       $titlesFile = 'titles.xml';
    
       if (file_exists($titlesFile)) {
        $xml = simplexml_load_file($titlesFile);
